...
public class RsaKeyHelper {
     ...
     * @throws Exception
     */
    public PublicKey getPublicKey(String filename, String key) throws Exception {
        Map<String, Object> objectMap = ResourceUtils.getResource(filename).getMap();
        byte[] keyBytes = (new BASE64Decoder()).decodeBuffer((String)objectMap.get(key));
     ...
     * @throws Exception
     */
    public PrivateKey getPrivateKey(String filename, String key) throws Exception {
        Map<String, Object> objectMap = ResourceUtils.getResource(filename).getMap();
        byte[] keyBytes = (new BASE64Decoder()).decodeBuffer((String)objectMap.get(key));
